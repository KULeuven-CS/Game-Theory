...
The following is the corresponding matrix with the best responses marked ($\underline{underline}$ for row player, $\overline{overline}$ for column player): 
	\begin{center}
	    ...
	    \hline
		& $(Trust,Trust)$ & $(Distrust,Trust)$ & $(Trust,Distrust)$ & $(Distrust,Distrust)$\\
		\hline
		$(Not Play,Steal)$ & $(1,\overline{1})$ & $(1,\overline{1})$ & \textcolor{blue}{$(\underline{1},\overline{1})$} & \textcolor{blue}{$(\underline{1},\overline{1})$} \\
		\hline
		$(Not Play,Share)$ & $(1,\overline{1})$ & $(1,\overline{1})$ & \textcolor{blue}{$(\underline{1},\overline{1})$} & \textcolor{blue}{$(\underline{1},\overline{1})$} \\
		\hline
		$(Play,Steal)$ & $(\underline{10},0)$ & $(\underline{10},0)$ & $(0,\overline{2})$ & $(0,\overline{2})$ \\
		\hline
		$(Play,Share)$ & $(5,\overline{5})$ & $(5,\overline{5})$ & $(0,2)$ & $(0,2)$ \\
		\hline
	    \end{tabular}
    \end{center}
\begin{itemize}
	...
	$$\{\Big((Not Play, Share),(Trust,Distrust)\Big),$$
	$$\Big((Not Play, Steal),(Trust,Distrust)\Big),$$
	$$\Big((Not Play, Share),(Distrust,Distrust)\Big),$$
	$$\Big((Not Play, Steal),(Distrust,Distrust)\Big)\}$$
%TODO: verify
